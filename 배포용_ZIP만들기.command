...
echo "  2. Workers & Pages > 2609-leeum-kidslab"
echo "  3. Create deployment (또는 Upload assets)"
echo "  4. 방금 만든 zip 을 창에 끌어다 놓기"
echo "  5. 배포가 끝나면 아래 주소로 확인"
echo "       https://2609-leeum-kidslab.pages.dev/a/     01"
echo "       https://2609-leeum-kidslab.pages.dev/b/     02"
echo "       https://2609-leeum-kidslab.pages.dev/c/     03"
echo
